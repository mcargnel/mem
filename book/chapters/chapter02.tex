En este capítulo se hará una revisión sobre árboles de regresión y clasificación (CART).
...
\subsection{Definir cuando un nodo es terminal} %# TODO: completar la sub-sección
...
\subsection{Outliers}
Es sabido que las regresiones lineales son muy sensibles a \textit{outliers}. Sin embargo, como se ve en Breiman los valores atípicos terminan siendo aislados en pequeños nodos. Esta capacidad de aislar los \textit{outliers} permite hacer el modelo menos sensible a datos atípicos.
